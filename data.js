...
provider:'KAYENTA (PMI ATP)',bookingUrl:'https://www.kayenta.de/pmp-zertifizierung.html',
...
provider:'SERVIEW',bookingUrl:'https://www.serview.de/prince2-schulungen',
...
provider:'KEGON / SERVIEW',bookingUrl:'https://www.kegon.de/safe-trainings',
...
provider:'APMG International',bookingUrl:'https://apmg-international.com/product/aipm',
...
provider:'PMI / KAYENTA',bookingUrl:'https://www.kayenta.de/capm-zertifizierung.html',
...
provider:'Fraunhofer IAIS / FIT',bookingUrl:'https://www.bigdata.fraunhofer.de/ki-manager',
...
function getFinderResults(careerLevel,market,pmRole){
  ...
  const map={
    ...
    'einstieg|agile':['psm1','aipm'],
    'einstieg|product':['psm1','aipm'],
    'einstieg|pmo':['capm','psm1'],
    'einstieg|programm':['capm','psm1'],
    'einstieg|ki':['psm1','aipm'],
    'aufbau|klassisch':['pmp','prince2','psm1'],
    'aufbau|agile':['psm1','pmp','pmiacp'],
    'aufbau|product':['psm1','pmp'],
    ...
    'spezialist|klassisch':['pmp','ipma'],
    'spezialist|agile':['safe','pmiacp','pmp'],
    'spezialist|product':['psm1','pmp'],
